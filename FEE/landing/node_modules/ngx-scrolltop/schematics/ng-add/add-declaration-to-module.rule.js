...
function addDeclarationToAppModule(appModule) {
    return (host) => {
        ...
        const modulePath = core_1.normalize('/' + appModule);
        ...
        const changes = ast_utils_1.addSymbolToNgModuleMetadata(source, modulePath, 'imports', 'NgxScrollTopModule', 'ngx-scrolltop');
